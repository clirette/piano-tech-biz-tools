...
interface InvoiceClientInfoFormProps {
  invoice: Invoice;
  onChange: (changes: Partial<Invoice>) => void;
}

export function InvoiceClientInfoForm({ invoice, onChange }: InvoiceClientInfoFormProps) {
  return (
